...
import { LayoutDashboard, Calendar, Bed, CreditCard, Stethoscope, Users, UserPlus, LogOut, Settings, Package, Pill, FileText, Menu, X, BarChart3, FlaskConical } from 'lucide-react'
      ...
      <div className="h-20 flex items-center justify-between px-6 border-b border-slate-200">
        {!collapsed && (
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-2xl text-slate-900">RCMC</span>
          </div>
        )}
        {collapsed && (
